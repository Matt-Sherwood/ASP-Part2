...
pub const struct_Context = extern struct {
    rax: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    rbx: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    rcx: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    rdx: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    rbp: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    rsi: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    rdi: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    r8: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    r9: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    r10: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    r11: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    r12: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    r13: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    r14: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    r15: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    rip: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    rsp: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
